...
console.log(`La valeur de "randomNumber" est ${randomNumber}`)

// Je génère l'arrondi de 13,4
const roundedNumber = Math.round(13.8)
console.log(`L'arrondi de "roundedNumber" est ${roundedNumber}`)
